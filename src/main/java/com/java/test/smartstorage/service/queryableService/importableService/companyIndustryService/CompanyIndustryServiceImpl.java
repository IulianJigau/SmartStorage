...
public class CompanyIndustryServiceImpl extends ImportableServiceAbs<CompanyIndustry, CompanyIndustryFlat> implements CompanyIndustryService {
    public CompanyIndustryServiceImpl(CompanyIndustryMapper companyIndustryMapper, ImportService importService, CompanyIndustryImportSettings companyIndustryImportSettings) {
